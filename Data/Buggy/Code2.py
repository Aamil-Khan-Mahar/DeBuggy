...
tracker = FlightTrackerr(flights_data)
...
print("Total passengers:", tracker.get_total_passenger())
print("Flights by airline 'Delta':", tracker.get_flights_byy_airline('Delta'))
...
print("Flights by status 'On Time':", tracker.get_fligghts_by_status('On Time'))
